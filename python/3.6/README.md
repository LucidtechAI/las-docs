...
* **Raises**
    ...
    * **TooManyRequestsException** – If limit of requests per second is reached


    * **LimitExceededException** – If limit of total requests per month is reached


    * **requests.exception.RequestException** – If error was raised by requests
...
* **Parameters**
    ...
    * **model_name** (*int*) – The name of the model to use for inference


    * **max_pages** – Maximum number of pages to run predictions on


    * **auto_rotate** – Whether or not to let the API try different rotations on the document when running
